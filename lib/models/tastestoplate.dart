...
Tastestoplate tastestoplateFromJson(String str) => Tastestoplate.fromJson(json.decode(str));
...
class Tastestoplate {
    ...
    factory Tastestoplate.fromJson(Map<String, dynamic> json) => Tastestoplate(
        status: json["status"],
        category: List<CuisineElement>.from(json["category"].map((x) => CuisineElement.fromJson(x))),
        slider: List<Slider>.from(json["slider"].map((x) => Slider.fromJson(x))),
        productDeal: List<Featured>.from(json["product_deal"].map((x) => Featured.fromJson(x))),
        ...
        city: List<CityElement>.from(json["city"].map((x) => CityElement.fromJson(x))),
        combo: List<dynamic>.from(json["combo"].map((x) => x)),
        cuisine: List<CuisineElement>.from(json["cuisine"].map((x) => CuisineElement.fromJson(x))),
        serviceCity: List<CityElement>.from(json["service_city"].map((x) => CityElement.fromJson(x))),
...
enum CategoryEnum { THE_6050_BB1256_CB9_D00088521_BC, THE_6050_BF608_F37_B70008_B0_ED38 }
...
enum CityEnum { THE_6049_F3_DB426_AC9000878_DDF6, THE_6049_F401426_AC9000878_DDF7, THE_6049_F399426_AC9000878_DDF5, THE_6049_F425426_AC9000878_DDF8, THE_6040_EAE14_A4_B6_C0008_FE1_AFF }
...
enum Cuisine { THE_603_F7100_F0_FABB000820850_B, THE_603_F70_A1_F0_FABB0008208509, THE_603_F7140_F0_FABB000820850_D, THE_603_F712_FF0_FABB000820850_C, THE_603_F70_AFF0_FABB000820850_A, THE_604_B4_A98_DBD6250008_FD88_E6, THE_603_F7096_F0_FABB0008208508 }
...
enum SubCategory { THE_60546_AC1595327000817509_E, THE_60546_B27595327000817509_F, THE_60546_E2859532700081750_A0, THE_6050_C66_F9563_FE000877683_B, THE_606_ECA9_C19796600085_C1660, THE_62_B16_F2_B67_B5_EA75_B0_B0_A2_F4 }
...
final exclusiveValues = EnumValues({
    "": Exclusive.EMPTY,
    "no": Exclusive.NO,
    "yes": Exclusive.YES
});
